...
<dl>
	...
	<dd>You can specify a custom function to verify if a drop location is allowed. The parent parameter is set to be the target placeholder. The target list can be obtained by getting the parent of the parent parameter. Default: <b>function(item, parent) { return true; }</b></dd>
</dl>
